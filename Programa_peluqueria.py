...
def ingresar_datos_cita():
    ...
    try:
        ...
        cursor.execute("INSERT INTO cita (fecha, hora_inicio, hora_fin, rut, id_sede) VALUES (%s, %s, %s, %s, %s) RETURNING id_cita", 
                       (fecha, hora_inicio, hora_fin, rut_cliente, id_sede))
